...
// EXAMPLE:
const namedOne = new NamedOne("John", "Doe");

console.log(namedOne.firstName); // John
console.log(namedOne.lastName); // Doe
console.log(namedOne.fullName); // John Doe

namedOne.firstName = "Jane";
console.log(namedOne.firstName); // Jane
console.log(namedOne.fullName); // Jane Doe

namedOne.firstName = "Jane";
namedOne.lastName = "Smith";
console.log(namedOne.lastName); // Smith
console.log(namedOne.fullName); // Jane Smith

namedOne.fullName = "Juan Herrero";
console.log(namedOne.firstName); // Juan
console.log(namedOne.lastName); // Herrero
console.log(namedOne.fullName); // Juan Herrero
